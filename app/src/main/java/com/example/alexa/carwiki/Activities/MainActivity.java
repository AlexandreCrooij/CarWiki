...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Owner owner1 = new Owner(1, "Alex", "Crooij", "owner");
        Owner owner2 = new Owner(2, "Danilo", "Marty", "owner");
        Owner owner3 = new Owner(3, "Mathis", "Fux", "owner");
        Owner owner4 = new Owner(4, "Anthony", "Ritz", "owner");
        Owner owner5 = new Owner(5, "Alex", "Crooij", "owner");
        Owner owner6 = new Owner(6, "Danilo", "Marty", "owner");
